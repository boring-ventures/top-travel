...
import { MapPin, Star, ArrowLeft, Crown, Sparkles } from "lucide-react";
import Link from "next/link";
import Image from "next/image";
import WhatsAppCTA from "@/components/utils/whatsapp-cta";

interface QuinceaneraDestinationPageProps {
  params: Promise<{ slug: string }>;
}

export default async function QuinceaneraDestinationPage({
  params,
      ...
      <main className="flex-grow relative">
        ...
        <section className="relative h-[50vh] sm:h-[60vh] min-h-[400px] sm:min-h-[500px] overflow-hidden">
          {destination.heroImageUrl ? (
            ...
            <div className="h-full bg-gradient-to-br from-[#e03d90]/20 to-[#e03d90]/10" />
          )}
                  ...
                  <div className="lg:sticky lg:top-8">
                    <div className="bg-white border border-gray-200 rounded-lg p-4 sm:p-6 shadow-sm w-full">
                      ...
                      <p className="text-sm sm:text-base text-gray-600 mb-4 sm:mb-6">
                        ...
                        hacer realidad tu quinceañera perfecta en{" "}
                        {destination.name}.
                      </p>
                    ...
                    <div className="mt-4 sm:mt-6 bg-gray-50 rounded-lg p-4 sm:p-6 w-full">
                      ...
                      <div className="space-y-2 sm:space-y-3">
                        <div className="flex items-center gap-2 sm:gap-3">
                          <MapPin className="h-4 w-4 text-[#e03d90] flex-shrink-0" />
                          <span className="text-sm sm:text-base text-gray-600">
                            {destination.location || destination.name}
                          </span>
                        </div>
                        <div className="flex items-center gap-2 sm:gap-3">
                          <Crown className="h-4 w-4 text-[#e03d90] flex-shrink-0" />
                          <span className="text-sm sm:text-base text-gray-600">
                        ...
                        {destination.isFeatured && (
                          <div className="flex items-center gap-2 sm:gap-3">
                            <Star className="h-4 w-4 text-[#e03d90] flex-shrink-0" />
                            <span className="text-sm sm:text-base text-gray-600">
                              Destino destacado
                            </span>
                          </div>
        ...
        {/* CTA Section */}
        <section className="py-12 sm:py-16 bg-gradient-to-r from-[#e03d90] to-[#e03d90]/80">
          <div className="container mx-auto px-4 sm:px-6 text-center">
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-white mb-4">
              ¿Lista para planificar tu quinceañera perfecta?
            </h2>
