...
function AnimatedHero({
  ...
  animatedWords = ["Maravillas", "Aventuras", "Experiencias", "Sueños", "Momentos"],
  ...
  return (
    <div className="relative w-full h-screen overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className={`absolute -bottom-40 -left-40 w-80 h-80 ${accentColor}/20 rounded-full blur-3xl animate-pulse delay-1000`}></div>
        ...
        <div className={`absolute top-20 right-20 w-4 h-4 ${accentColor} rounded-full opacity-60 animate-pulse delay-300`}></div>
        <div className={`absolute bottom-32 right-1/4 w-2 h-2 ${accentColor} rounded-full opacity-40 animate-pulse delay-700`}></div>
        <div className={`absolute top-1/3 left-20 w-3 h-3 ${accentColor} rounded-full opacity-50 animate-pulse delay-1000`}></div>
      </div>
