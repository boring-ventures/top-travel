...
interface PdfSectionProps {
  pdfUrl: string;
  title: string;
  documentType: string; // e.g., "paquete", "oferta", "evento", "destino", "salida fija"
  description?: string;
}
...
export function PdfSection({
  ...
  const defaultDescription = `Descarga el documento PDF con toda la información completa del ${documentType}, incluyendo detalles, precios y condiciones.`;
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="flex-1">
            <h4 className="font-medium text-black/80 mb-1">
              Información detallada del {documentType}
            </h4>
